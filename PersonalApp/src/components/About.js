    ...
    return(
        <ScrollView style={{padding : 20 , backgroundColor : 'white' }} >
            <Text style={styles.textStyle}>
                ...
                As a front end developer , I've many years of experience in <Text style={styles.highlight}>React.js</Text> library. I am simply a React developer. Similarly, i have a very good knowledge of Material UI , Ant D , Redux ( for better state management ), and React-Hooks. {"\n"}{"\n"}
